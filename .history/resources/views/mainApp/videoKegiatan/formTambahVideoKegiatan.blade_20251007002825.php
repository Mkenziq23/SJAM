...
function updateVideoPreview() {
    const url = document.getElementById('txtLinkVideo').value;
...
function previewImage(type = 'thumbnail') {
    const input = document.getElementById(type === 'thumbnail' ? 'txtThumbnailVideoKegiatan' : 'txtFotoKegiatan');
    const preview = document.getElementById(type === 'thumbnail' ? 'videoThumbnailPreview' : 'addImagePreview');
