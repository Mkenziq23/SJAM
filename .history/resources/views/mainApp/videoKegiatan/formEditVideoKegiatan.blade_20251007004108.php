<!-- Form Edit Video Kegiatan -->
<div id="divEditVideoKegiatan" class="container-fluid px-4 py-4" style="display: none;">
    <!-- Tombol Kembali -->
    <div class="mb-4">
        <button class="btn btn-outline-secondary btn-lg fw-semibold" @click="kembaliAtc()">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-gradient-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-video me-2"></i> Form Edit Video Kegiatan</h5>
                </div>
                <div class="card-body">
                    <!-- Nama Kegiatan -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img class="img-thumbnail img-fluid d-block mb-3" id="imgEditThumbnail"
                             style="max-height:200px;" alt="Preview Thumbnail" />
                        <input type="file" class="form-control" id="txtEditThumbnailVideoKegiatan"
                    ...
                    <!-- Video Preview -->
                    <div class="mb-3 text-center" id="editVideoPreview" style="display: none;">
                    ...
                    <!-- Submit Button -->
                    <div>
                        <button class="btn btn-primary btn-lg w-100 fw-semibold mt-3" @click="prosesEditKegiatanAtc()">
...
<!-- Custom CSS (sama dengan form tambah) -->
<style>
.card {
    border-radius: 16px;
    overflow: hidden;
