    ...
    methods: {
        editAtc: function (id) {
            ...
            axios.post(rGetDataSetting, ds).then(function (res) {
                document.querySelector("#txtNamaSetting").value =
                    res.data.dataSetting.nama_setting;
                document.querySelector("#txtNilaiSetting").value =
                    res.data.dataSetting.value;
                $("#divDataSetting").hide();
