                ...
                @foreach ($dataAbsensi as $absensi)
                    <tr>
                        ...
                        <td class="text-center">
                            @if($absensi->active == '1')
                                <span class="badge bg-success rounded-start fs-4 px-2 py-2">Hadir</span>
                            @elseif($absensi->active == '2')
                                <span class="badge bg-warning text-dark rounded-start fs-4 px-2 py-2">Izin</span>
                            @else
                                <span class="badge bg-danger rounded-start fs-4 px-2 py-2">Alfa</span>
                            @endif
                        </td>
                        <td class="text-center">
