                    ...
                    @foreach ($dataAbsensi as $absensi)
                        <tr>
                            ...
                            <td class='text-center'>
                                @if($absensi->active == '1')
                                    <span class="badge bg-success" style="font-size:1.2rem; padding:0.6rem 1.2rem;">Hadir</span>

                                @elseif($absensi->active == '2')
                                    <span class="badge bg-warning text-dark" style="font-size:1.2rem; padding:0.6rem 1.2rem;">Izin</span>
                                @else
                                    <span class="badge bg-danger" style="font-size:1.2rem; padding:0.6rem 1.2rem;">Alfa</span>
                                @endif
                            </td>
                            <td>
