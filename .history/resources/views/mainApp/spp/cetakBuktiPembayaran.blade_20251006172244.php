...
<body>
    ...
    <div class="kop-surat">
        ...
        <h2>{{ $settings['nama_lembaga'] ?? 'Nama Lembaga' }}</h2>
        <h3>{{ $settings['alamat_lembaga'] ?? 'Alamat lembaga belum diatur' }}</h3>
        <p>
            Telp. {{ $settings['telp_lembaga'] ?? '-' }} |
            Email: {{ $settings['email_lembaga'] ?? '-' }}
        </p>
    </div>
