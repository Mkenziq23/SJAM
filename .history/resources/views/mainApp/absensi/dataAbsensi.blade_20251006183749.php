...
<div id="divDataAbsensi" class="container-fluid px-4 py-4">
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3 px-4 rounded-top-4">
            <h5 class="mb-0">
                <i class="fas fa-calendar-check me-2"></i> Rekapitulasi Absensi Santri
            </h5>
            <div>
                    ...
                    <tbody>
                        @foreach ($dataAbsensi as $absensi)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-danger btn-sm" @click="hapusAbsensiAtc('{{ $absensi->token_absensi }}')">
