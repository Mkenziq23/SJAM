<div id="divDataAbsensi" class="container mt-4">
    <div class="mb-3">
        <a href="javascript:void(0)" class="btn btn-primary btn-lg me-2" @click="tambahAbsensiAtc()">
            <i class="fas fa-plus-circle"></i> Rekap Absensi Hari Ini
        </a>
        <a href="javascript:void(0)" class="btn btn-info btn-lg text-white" @click="tambahAbsensiAtc()">
                        ...
                        @foreach ($dataAbsensi as $absensi)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($absensi->active == '1')
                                        <span class="badge bg-success fs-6 px-3 py-2 rounded-2">Hadir</span>
                                    @elseif($absensi->active == '2')
                                        <span class="badge bg-warning text-dark fs-6 px-3 py-2 rounded-2">Izin</span>
                                    @else
                                        <span class="badge bg-danger fs-6 px-3 py-2 rounded-2">Alfa</span>
                                    @endif
                                </td>
                                <td class="text-center">
