...
var santriApp = new Vue({
    ...
    methods: {
        ...
        clearForm: function () {
            ...
            document.querySelector("#txtJk").value = "none";
            document.querySelector("#txtTanggalLahir").value = "";
            document.querySelector("#txtTempatLahir").value = "";
            document.querySelector("#txtStatusOrtu").value = "LENGKAP";
            document.querySelector("#txtAlamat").value = "";
            document.querySelector("#txtNoHp").value = "";
            document.querySelector("#txtEmail").value = "";
            document.querySelector("#txtNamaOrangTua").value = "";
            document.querySelector("#txtKelas").value = "none";
            document.querySelector("#txtKafilah").value = "none";
        },
        prosesTambahSantriAtc: async function () {
            ...
            if (
                ...
                pesanUmumApp(
                    "warning",
                    "Isi field !!!",
                    "Harap isi nama, jk, alamat, & kafilah"
                );
            } else {
                let ds = {
                    nama: nama,
        ...
        editAtc: function (idSantri) {
            ...
            axios.post(rGetDataEdit, ds).then(function (res) {
                ...
                document.querySelector("#txtIdSantriEdit").value =
                    res.data.dataSantri.id_santri;
                document.querySelector("#txtAlamatEdit").value =
                    res.data.dataSantri.alamat;
                document.querySelector("#txtTglLahirEdit").value =
                    res.data.dataSantri.tanggal_lahir;
                document.querySelector("#txtNamaSantriEdit").value =
                    res.data.dataSantri.nama;
                document.querySelector("#txtKafilahEdit").value =
                    res.data.dataSantri.id_kafilah;
                document.querySelector("#txtKelasEdit").value =
                    res.data.dataSantri.kelas;
    ...
    axios.post(rProcessUpdateSantri, ds).then(function (res) {
        ...
        setTimeout(function () {
            pesanUmumApp(
                "success",
                "Sukses",
                "Berhasil mengupdate data santri"
            );
            load_page(rSantri, "Santri");
        }, 300);
    });
