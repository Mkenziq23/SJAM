...
<section class="penilaian-section py-5" id="penilaian">
    ...
    <div class="container">
        ...
        <!-- Carousel Penilaian -->
        <div class="row">
            <div id="carouselPenilaian" class="owl-carousel owl-theme">
                ...
                @empty
                    <div class="text-center text-light">Belum ada penilaian dari masyarakat.</div>
                @endforelse
            </div>
        </div>
            ...
            <div class="modal-body p-4">
                <form action="{{ route('ratings.store') }}" method="POST">
                    ...
                    <div class="mb-3 text-center">
                        <label class="form-label d-block mb-2">Bintang</label>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 fade-in">
                <div class="p-4 bg-white rounded-4 shadow-lg border-start border-4 border-primary position-relative z-2">
                    ...
                    <p class="text-muted mb-4">{{ $setting->noRekening ?? '123456789' }} a.n {{ $setting->namaTahfiz ?? 'Rumah Tahfidz SJAM' }}</p>
