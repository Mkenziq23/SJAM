                ...
                <div class="col-md-4 fade-in">
                    <div class="card h-100 shadow-lg rounded-4 border-0 overflow-hidden hover-card">
                        <div class="ratio ratio-16x9">
                            @if($vKegiatan->thumbnail_video)
                                <!-- tampilkan thumbnail -->
                                <img src="{{ asset('storage/' . $vKegiatan->thumbnail_video) }}" 
                                    class="rounded-top w-100 h-100 object-fit-cover" alt="{{ $vKegiatan->nama_kegiatan }}">
                            @else
                                <!-- fallback ke iframe jika thumbnail tidak ada -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="card shadow-lg rounded-4 p-4 text-center fade-in">
                        <div class="position-relative mb-3">
                            <i class="mdi mdi-format-quote-open display-4 text-primary position-absolute top-0 start-50 translate-middle-x"></i>
                        </div>
                        <img src="{{ $penilaian->avatar ?? 'https://i.pravatar.cc/150?img=' . rand(1, 70) }}" 
                             alt="{{ $penilaian->name }}" 
                             class="img-fluid mx-auto d-block rounded-circle user-img mb-3">
                        <h5 class="fw-bold mb-1">{{ $penilaian->name }}</h5>
                        <p class="text-muted f-15 mb-2">{{ $penilaian->reason }}</p>
                ...
                <div class="col-12 text-center">
                    <p class="fs-5 text-light">Belum ada penilaian dari masyarakat.</p>
                </div>
                @endforelse
            </div>
        </div>
                ...
                <form id="ratingForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="ratingStars" class="d-flex gap-2">
                            @for ($i = 1; $i <= 5; $i++)
                                <span class="star cursor-pointer" data-value="{{ $i }}">
                                    <i class="mdi mdi-star-outline fs-3 text-warning"></i>
                                </span>
                            @endfor
                        </div>
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="p-3 p-lg-4 bg-white rounded-4 shadow-lg border-start border-4 border-primary fade-in">
                    ...
                    <h3 class="fw-bold text-dark mb-4">
                        Rumah Tahfidz Qur'an {{ $setting->namaTahfiz ?? 'SJAM' }}
                    </h3>
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div>
                            ...
                            <h4 class="fw-bold text-primary">
                                {{ $setting->namaBank ?? 'Bank BSI' }} <br>
                                <span class="text-dark small">{{ $setting->noRek ?? '123456789' }} a.n Rumah Tahfidz SJAM</span>
                            </h4>
                        </div>
