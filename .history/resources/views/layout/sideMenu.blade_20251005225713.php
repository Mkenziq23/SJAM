...
<div class="main-sidebar shadow" id="divMenu">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu mt-4">
            <li>
                <a class="nav-link" :class="{active: activeMenu === 'dashboard'}" @click="dashboardAtc()" href="javascript:void(0)">
                    <i class="fas fa-home"></i> <span>Dashboard</span>
                </a>
            </li>
            <li>
                <a class="nav-link" :class="{active: activeMenu === 'absensi'}" @click="absensiAtc()" href="javascript:void(0)">
                    <i class="fas fa-chart-bar"></i> <span>Absensi Harian</span>
                </a>
            </li>
            <li>
                <a class="nav-link" :class="{active: activeMenu === 'pembayaranSpp'}" @click="pembayaranSppAtc()" href="javascript:void(0)">
                    <i class="fas fa-chart-bar"></i> <span>Pembayaran SPP</span>
                </a>
            </li>
            <li>
                <a class="nav-link" :class="{active: activeMenu === 'buktiBayar'}" @click="buktiBayarAtc()" href="javascript:void(0)">
                    <i class="fas fa-chart-bar"></i> <span>Bukti Pembayaran SPP</span>
                </a>
            </li>

            {{-- Data Master --}}
            <li class="dropdown" :class="{active: ['santri','pendaftaran','pengurus'].includes(activeMenu)}">
            ...
            {{-- Keuangan --}}
            @if (Auth::user()->role != '2')
            <li class="dropdown" :class="{active: ['saldo','penggajian','pengeluaran','donasi','donasiBarang','cashFlow'].includes(activeMenu)}">
                <a href="javascript:void(0)" class="nav-link has-dropdown" data-toggle="dropdown">
            ...
            {{-- Laporan & Statistik --}}
            <li class="dropdown" :class="{active: ['laporanKeuangan','rekapAbsensi','penilaianMasyarakat'].includes(activeMenu)}">
                <a href="javascript:void(0)" class="nav-link has-dropdown" data-toggle="dropdown">
            ...
            {{-- Kegiatan --}}
            <li class="dropdown" :class="{active: ['kegiatan','videoKegiatan'].includes(activeMenu)}">
                <a href="javascript:void(0)" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-users"></i> <span>Kegiatan</span>
                </a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" :class="{active: activeMenu === 'kegiatan'}" href="javascript:void(0)" @click="kegiatanAtc()">
                        <i class="fas fa-images"></i> <span>Foto Kegiatan</span></a></li>
                    <li><a class="nav-link" :class="{active: activeMenu === 'videoKegiatan'}" href="javascript:void(0)" @click="videoKegiatanAtc()">
