    ...
    <div class="modal-content rounded-4 shadow-lg border-0">
      ...
      <div class="modal-body p-4">
        <form id="ratingForm">
          ...
          <div class="mb-3">
            <label for="ratingName" class="form-label fw-semibold">Nama</label>
            <input type="text" class="form-control" id="ratingName" placeholder="Masukkan nama anda" required>
          </div>

          <div class="mb-3">
            <label for="ratingReason" class="form-label fw-semibold">Alasan Penilaian</label>
            <textarea class="form-control" id="ratingReason" rows="3" placeholder="Masukkan ulasan anda" required></textarea>
          </div>

          <div class="mb-3">
            <label class="form-label fw-semibold">Pilih Bintang</label>
            <div id="ratingStars" class="d-flex gap-2 fs-2 text-warning">
