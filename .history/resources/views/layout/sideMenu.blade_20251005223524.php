@if (Auth::check())
    <div class="main-sidebar shadow" id="divMenu">
        <aside id="sidebar-wrapper">
            ...
            {{-- Sidebar Brand Mini --}}
            <div class="sidebar-brand sidebar-brand-sm text-center py-2">
            ...
            <ul class="sidebar-menu mt-4">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="nav-link" href="javascript:void(0)" @click="kegiatanAtc()">
                                <i class="fas fa-images"></i> <span>Foto Kegiatan</span>
                            </a>
                        </li>
                        <li>
                            <a class="nav-link" href="javascript:void(0)" @click="videoKegiatanAtc()">
                                <i class="fas fa-video"></i> <span>Video Kegiatan</span>
                            </a>
                        </li>
                    </ul>
                </li>
