        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted f-14">Jika anda atau putra/i anda ingin mendaftar menjadi santri Tahfiz
                        Al-Haziq, dapat melakukan pendaftaran langsung
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group app-label">
                                ...
                                <input id="txtNama" type="text" class="form-control"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group app-label">
                                ...
                                <input id="txtEmail" type="email" class="form-control"
                                    placeholder="Email calon santri/orang tua">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group app-label">
                                ...
                                <input id="txtTmpt" type="text" class="form-control"
                                    placeholder="Tempat lahir calon santri">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group app-label">
                                <label for="email">Tanggal Lahir</label>
                                <input id="txtTgl" type="date" class="form-control"
                                    placeholder="Tanggal lahir calon santri">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group app-label">
                                <label for="name">Nomor Hp (Whatsapp)</label>
                                <input id="txtHp" type="text" class="form-control"
                                    placeholder="Nomor hp santri/orang tua">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group app-label">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group app-label">
                                ...
                                <input type="text" class="form-control" id="txtOrangTua"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group app-label">
                                ...
                                <select class="form-control" id="txtKelas">
                                    ...
                                    <option value="LEADERSHIP DAN INTERPRENEURSHIP">
                                        leadership & interpreneurship</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group app-label">
                                ...
                                <textarea id="txtHarapan" rows="3" class="form-control"
                                    placeholder="Harapan & capaian yang ingin diraih setelah belajar di rumah tahfiz al haziq"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="javascript:void(0)" class="btn btn-primary" id="btnProses"
                                onclick="prosesPendaftaran()">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-6 text-center">
                ...
                <div class="mb-4">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('/ladun/base') }}/img/sjam-1.jpg" alt="" class="rounded-circle"
                            height="150">
                    </a>
                </div>
            ...
            <div class="col-lg-7 offset-lg-1">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h5 class="footer-list-title f-18 font-weight-normal mb-3">{{ $setting->namaTahfiz }}</h5>
                        <ul class="list-unstyled company-sub-menu">
