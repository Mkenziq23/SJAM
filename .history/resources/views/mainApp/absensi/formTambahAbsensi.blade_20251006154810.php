                                            ...
                                            <div class="d-flex justify-content-center gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status_{{ $santri->id_santri }}"
                                                           id="hadir_{{ $santri->id_santri }}" value="1" @if($status==1) checked @endif
                                                           @click="setAbsensiAtc('{{ $santri->id_santri }}', 1, '{{ $santri->nama }}')">
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status_{{ $santri->id_santri }}"
                                                           id="izin_{{ $santri->id_santri }}" value="2" @if($status==2) checked @endif
                                                           @click="setAbsensiAtc('{{ $santri->id_santri }}', 2, '{{ $santri->nama }}')">
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status_{{ $santri->id_santri }}"
                                                           id="alfa_{{ $santri->id_santri }}" value="0" @if($status==0) checked @endif
