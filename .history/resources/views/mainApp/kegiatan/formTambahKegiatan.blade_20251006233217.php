            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <img class="img-thumbnail img-fluid d-block mb-3" id="addImagePreview" style="max-height:200px;">
                        <input type="file" class="form-control" id="txtFotoKegiatan" onchange="previewImage('add')">
                    </div>
                    <div>
                        <button class="btn btn-primary btn-lg w-100" @click="prosesTambahKegiatanAtc()">
