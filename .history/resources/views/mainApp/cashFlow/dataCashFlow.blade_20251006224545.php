    ...
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3 px-4 rounded-top-4">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-light btn-sm fw-semibold" id="btnExportCSV">
                    <i class="fas fa-file-csv me-1"></i> CSV
                </button>
                <button class="btn btn-light btn-sm fw-semibold" id="btnExportExcel">
                    <i class="fas fa-file-excel me-1"></i> Excel
                </button>
                <button class="btn btn-light btn-sm fw-semibold" id="btnPrint">
