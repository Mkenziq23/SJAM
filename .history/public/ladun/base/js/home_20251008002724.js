...
$(document).ready(function(){
    $(".owl-carousel").owlCarousel({
        loop: true,                // akan berputar terus
        margin: 15,                // jarak antar kartu
        nav: true,                 // tombol next / prev
        dots: true,                // titik navigasi bawah
        autoplay: true,            // otomatis berjalan
        autoplayTimeout: 3500,     // waktu antar slide
        autoplayHoverPause: true,  // berhenti saat di-hover
        responsive:{
            0:{ items:1 },         // tampilan HP → 1 kartu
            576:{ items:2 },       // tampilan tablet → 2 kartu
            992:{ items:3 },       // tampilan laptop → 3 kartu
            1200:{ items:4 }       // tampilan besar → 4 kartu
        }
    });
});