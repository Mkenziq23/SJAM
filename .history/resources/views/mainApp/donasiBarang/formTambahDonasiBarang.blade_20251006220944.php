        ...
        <div class="col-lg-6 col-md-8 col-sm-10 col-12 mt-3">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-header bg-gradient-primary text-white d-flex align-items-center">
                    ...
                    <h4 class="mb-0">Form Tambah Donasi Barang</h4>
                </div>
                <!-- Body -->
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <label for="txtNamaBarang" class="form-label fw-semibold">Nama Barang</label>
                        <textarea class="form-control" id="txtNamaBarang" style="resize:none;" placeholder="Masukkan nama barang"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="txtTipe" class="form-label fw-semibold">Tipe Donatur</label>
                        <select class="form-control" id="txtTipe">
                            <option value="" disabled selected>-- Pilih Tipe Donatur --</option>
                    ...
                    <div class="mb-3">
                        <label for="txtJumlah" class="form-label fw-semibold">Jumlah</label>
                        <input type="text" class="form-control" id="txtJumlah" placeholder="Masukkan jumlah barang" />
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <button class="btn btn-primary btn-lg flex-grow-1" @click="prosesTambahDonasiBarangAtc()">
                            <i class="fas fa-save me-1"></i> Proses Donasi Barang
                        </button>
